  ...
  <div class="nav-menu-modal">
    <div class="content">
      <div class="hrefs" ref="nav_menu_hrefs">
        ...
        <nuxt-link class="nav-menu-btn nav-menu-btn-text" to="/people" @click.native="setModalIsActive">People</nuxt-link>
        <nuxt-link class="nav-menu-btn nav-menu-btn-text" to="/project" @click.native="setModalIsActive">Project</nuxt-link>
        <nuxt-link class="nav-menu-btn nav-menu-btn-text" to="/process" @click.native="setModalIsActive">Process</nuxt-link>
      </div>
