<template>
  <div class="carousel-wrapper"
       id="spinnerBlock"
       @mouseover="mouseInAction"
       @mouseout="mouseLeaveAction">

    <div :class="['custom-cursor', {'custom-cursor-active':cursorActive}]"
         :style="cursorCircle">
...
<script>
    ...
    export default {
        ...
        computed: {
            cursorCircle() {
                return `transform: translateX(${this.xCursor}px) translateY(${this.yCursor}px);`
            }
        },
